...
import { ChangeDetectorRef, Component, ElementRef, Renderer2, ViewChild, signal } from '@angular/core';
...
export class GridComponent {
  ...
  public iEmployee = signal<IEmployee[]>([
    {
      Age: 55,
  ...
  public data: IEmployee[] = this.iEmployee();
